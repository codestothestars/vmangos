...
(             1026,     -1,      179,      578), -- Mage AND Level >= 40 AND Does not know Portal: Stormwind
(             1027,     -1,      179,      579), -- Mage AND Level >= 40 AND Does not know Portal: Ironforge
(             1028,     -1,      179,      580), -- Mage AND Level >= 40 AND Does not know Portal: Orgrimmar
(             1029,     -1,      179,      581), -- Mage AND Level >= 40 AND Does not know Portal: Undercity
(             1030,     -1,      179,      582), -- Mage AND Level >= 40 AND Does not know Portal: Darnassus
(             1031,     -1,      179,      583), -- Mage AND Level >= 40 AND Does not know Portal: Thunder Bluff
