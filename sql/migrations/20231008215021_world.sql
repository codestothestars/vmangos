...
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 240, 56,     0, 150, 0x1);
...
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 550, 20, 12435,  90, 0x0);
--  551: No nearby Razorgore within 90 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 551, 20, 12435,  90, 0x1);
--  552: Nearby Razorgore within 70 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 552, 20, 12435,  70, 0x0);
--  553: No nearby Razorgore within 70 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 553, 20, 12435,  70, 0x1);
--  554: Nearby Razorgore within 50 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 554, 20, 12435,  50, 0x0);
--  555: No nearby Razorgore within 50 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 555, 20, 12435,  50, 0x1);
--  556: Hostile unit within 10 yards
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES ( 556, 59,    10,   0, 0x0);
-- 8302: Map event 8302 (Razorgore) is active
INSERT `conditions` (`condition_entry`, `type`, `value1`, `value2`, `flags`) VALUES (8302, 36,  8302,   0, 0x0);
...
-- Spawning Adds
INSERT `generic_scripts`
(  `id`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `target_type`, `target_param1`, `target_param2`, `data_flags`, `dataint`, `dataint2`, `x`, `condition_id`, `comments`) VALUES
(830203,         3,          2,           0,       0x000,         0x0,             8,           12435,             150,         0x00,         0,          0,   5,              0, 'Razorgore Event Spawning Adds - Move to Razorgore'),
(830204,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            550, 'Razorgore Event Spawning Adds - Initial Movement (North) - Move to Razorgore'),
(830204,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830204,   0,            551, 'Razorgore Event Spawning Adds - Initial Movement (North) - Move to Altar'),
(830205,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            550, 'Razorgore Event Spawning Adds - Initial Movement (East) - Move to Razorgore'),
(830205,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830205,   0,            551, 'Razorgore Event Spawning Adds - Initial Movement (East) - Move to Altar'),
(830206,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            552, 'Razorgore Event Spawning Adds - Initial Movement (East South) - Move to Razorgore'),
(830206,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830206,   0,            553, 'Razorgore Event Spawning Adds - Initial Movement (East South) - Move to Altar'),
(830207,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            554, 'Razorgore Event Spawning Adds - Initial Movement (South East) - Move to Razorgore'),
(830207,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830207,   0,            555, 'Razorgore Event Spawning Adds - Initial Movement (South East) - Move to Altar'),
(830208,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            554, 'Razorgore Event Spawning Adds - Initial Movement (South) - Move to Razorgore'),
(830208,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830208,   0,            555, 'Razorgore Event Spawning Adds - Initial Movement (South) - Move to Altar'),
(830209,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            554, 'Razorgore Event Spawning Adds - Initial Movement (West) - Move to Razorgore'),
(830209,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830209,   0,            555, 'Razorgore Event Spawning Adds - Initial Movement (West) - Move to Altar'),
(830210,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            554, 'Razorgore Event Spawning Adds - Initial Movement (West North) - Move to Razorgore'),
(830210,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830210,   0,            555, 'Razorgore Event Spawning Adds - Initial Movement (West North) - Move to Altar'),
(830211,        39,     830203,           0,           0,           0,             0,               0,               0,         0x00,       100,          0,   0,            552, 'Razorgore Event Spawning Adds - Initial Movement (North West) - Move to Razorgore'),
(830211,        60,          3,           1,           0,           0,             0,               0,               0,         0x00,         0,     830211,   0,            553, 'Razorgore Event Spawning Adds - Initial Movement (North West) - Move to Altar'),
(830212,        10,      12416,           0,           0,           0,              ,                ,                ,             ,      0x00,     830204,    ,              0, 'Razorgore Event Spawning Adds - Summon Blackwing Legionnaire - North');
