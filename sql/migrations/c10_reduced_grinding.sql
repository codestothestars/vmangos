...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` = 160 WHERE `creature_id` IN (7440, 7441);         -- Winterfall Den Watcher, Totemic
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` = 192 WHERE `creature_id` =  7442;                 -- Winterfall Pathfinder
...
UPDATE `quest_template` SET `RewRepValue1` =  100 WHERE `entry` = 4970; -- Frostsaber Provisions
...
UPDATE `quest_template` SET `RewRepValue1` = 4800 WHERE `entry` = 8464; -- Winterfall Activity
