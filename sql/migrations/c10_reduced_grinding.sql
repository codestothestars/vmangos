...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` =  20 WHERE `creature_id` IN (7440, 7441);         -- Winterfall Den Watcher, Totemic
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` =  24 WHERE `creature_id` =  7442;                 -- Winterfall Pathfinder
...
UPDATE `quest_template` SET `RewRepValue1` =  600 WHERE `entry` = 8464; -- Winterfall Activity
