...
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` =  10 WHERE `creature_id` IN (7440, 7441);         -- Winterfall Den Watcher, Totemic
UPDATE `creature_onkill_reputation` SET `RewOnKillRepValue1` =  12 WHERE `creature_id` =  7442;                 -- Winterfall Pathfinder
...
UPDATE `quest_template` SET `RewRepValue1` =  300 WHERE `entry` = 8464; -- Winterfall Activity
