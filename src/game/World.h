...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_CODESTOTHESTARS_SCALE_RAID40_HEALERS,
    CONFIG_UINT32_CODESTOTHESTARS_SCALE_PLAYERS,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_CREATURE_DUNGEON_HP,
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_CREATURE_RAID10_HP,
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_CREATURE_RAID40_HP,
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_PLAYER_DUNGEON_HP,
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_PLAYER_RAID10_HP,
    CONFIG_FLOAT_CODESTOTHESTARS_RATE_PLAYER_RAID40_HP,
