...
FROM (
    ...
    WHERE spell_cast_start.caster_id = 10316 AND spell_cast_start.spell_id = 15580 AND creature_guid_values_update.field_name = 'Target'
    ...
    WHERE `current`.caster_id = 10316 AND `current`.spell_id = 15580
